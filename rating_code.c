...
//Reading CSV File
 char buffer[1024] ;
   ...
   int i=0,j=0;
   int mat[100][100];
      FILE *fstream = fopen("rating.csv","r+");
   if(fstream == NULL)
   {
      printf("\n file opening failed ");
      return -1 ;
...
float smoke[200],drink[200],ambience[200],hijos[200],interest[200],weight[200],budget[200],rating[200];
int a,b;
//printf("\n-------DATA SET:---------\n");
...
//Entropy for Rating     	
	...
	printf("\nEntropy for class Overall Rating is : %f",class);
//Entropy for Smoke
        float s1=0,s2=0;
